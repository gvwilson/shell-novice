...
(covered in [Navigating Files and Directories](02-filedir.qmd) section)
...
::: {.callout-note title="Home Directory Variation"}
...
![](episodes/fig/filesystem.svg){alt='The file system is made up of a root directory that contains sub-directories titled bin, data, users, and tmp'}
...
![](episodes/fig/home-directories.svg){alt='Like other directories, home directories are sub-directories underneath "/Users" like "/Users/imhotep", "/Users/larry" or"/Users/nelle"'}
...
::: {.callout-note title="Clearing your terminal" collapse="true"}
...
::: {.callout-note title="Help for built-in commands"}
...
::: {.callout-note title="Unsupported command-line options"}
...
::: {.callout-note title="Manual pages on the web"}
...
::: {.callout-important title="Exploring More ls Options"}
...
::: {.callout-important title="Listing in Reverse Chronological Order"}
...
the [setup for this lesson](setup.qmd). (On most systems, the
...
::: {.callout-note title="Other Hidden Files"}
...
::: {.callout-note title="Two More Shortcuts"}
...
::: {.callout-important title="Absolute vs Relative Paths"}
...
::: {.callout-important title="Relative Path Resolution"}
...
::: {.callout-important title="ls Reading Comprehension"}
...
![](episodes/fig/shell_command_syntax.svg){alt='General syntax of a shell command'}
