...
::: {.callout-note title="Follow the Prompt"}
...
::: {.callout-note title="Same Symbols, Different Meanings"}
...
::: {.callout-note title="Spaces in Names"}
...
![](episodes/fig/shell_script_for_loop_flow_chart.svg){alt='The for loop "for filename in .dat; do echo cp $filename original-$filename;done" will successively assign the names of all ".dat" files in your current directory to the variable "$filename" and then execute the command. With the files "basilisk.dat", "minotaur.dat" and "unicorn.dat" in the current directory the loop will successively call the echo command three times and print threelines: "cp basislisk.dat original-basilisk.dat", then "cp minotaur.datoriginal-minotaur.dat" and finally "cp unicorn.datoriginal-unicorn.dat"'}
...
::: {.callout-note title="Beginning and End"}
...
::: {.callout-note title="Those Who Know History Can Choose to Repeat It"}
...
::: {.callout-note title="Other History Commands"}
