...
::: {.callout-note title="Text vs. Whatever"}
...
::: {.callout-note title="Double-Quotes Around Arguments"}
...
::: {.callout-important title="List Unique Species"}
...
::: {.callout-important title="Why Record Commands in the History Before Running Them?"}
...
::: {.callout-important title="Variables in Shell Scripts"}
...
::: {.callout-important title="Find the Longest File With a Given Extension"}
...
::: {.callout-important title="Script Reading Comprehension"}
...
::: {.callout-important title="Debugging Scripts"}
