...
- The [Reference page](reference.qmd) can be printed out
...
- If everything is going well, you can drive home the point that file
  ...
  (covered briefly in
  [Navigating Files and Directories](02-filedir.qmd)).
  This can be done in the
  [Pipes and Filters](04-pipefilter.qmd) section by showing
